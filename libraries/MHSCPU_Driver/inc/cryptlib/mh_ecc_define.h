...
typedef struct
{
    ...
    uint8_t *pu8N;                                              
    uint8_t *pu8P;               
    uint8_t *pu8Space;            //for hardware space
    uint32_t u32SpaceLen;         //hardward space length
    uint32_t u32Crc;                            
} MHECC_PARAM;   
...
#define MH_RET_ECC_VERIFY_POINT_FAILURE      (MH_RET_ECC_INIT + 0x02)
#define MH_RET_ECC_VERIFY_KEY_FAILURE        (MH_RET_ECC_INIT + 0x03)
#define MH_RET_ECC_VERIFY_CURVE_FAILURE      (MH_RET_ECC_INIT + 0x04)
#define MH_RET_ECC_PONIT_RANG_CHECK_FAILURE  (MH_RET_ECC_INIT + 0x05) 
...
#define MH_RET_ECC_SHA_PARAM_ERR             (MH_RET_ECC_INIT + 0x0B)
#define MH_RET_ECC_SHA_BUSY                  (MH_RET_ECC_INIT + 0x0C)
