...
#define MH_RET_RSA_ATTACKED                  (MH_RET_RSA_INIT + 0x02)
#define MH_RET_RSA_FAILURE                   (MH_RET_RSA_INIT + 0x03)
#define MH_RET_RSA_ERR                       (MH_RET_RSA_INIT + 0x04) 
#define MH_RET_PRIME_NOT_ACCEPTABLE          (MH_RET_RSA_INIT + 0x05)
...
#define MH_RET_RSA_DFA_LOCK                  (MH_RET_RSA_INIT + 0x09)
