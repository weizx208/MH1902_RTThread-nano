...
#define MH_RET_SM1_PARAM_ERR                (MH_RET_SM1_INIT + 1)
#define MH_RET_SM1_INPUT_SIZE_ERROR         (MH_RET_SM1_INIT + 2)
#define MH_RET_SM1_KEY_LEN_ERR              (MH_RET_SM1_INIT + 3)
#define MH_RET_SM1_ROUND_ERR                (MH_RET_SM1_INIT + 4)
#define MH_RET_SM1_MODE_ERROR               (MH_RET_SM1_INIT + 5)
#define MH_RET_SM1_BLK_ERROR                (MH_RET_SM1_INIT + 6)
#define MH_RET_SM1_ATTACKED                 (MH_RET_SM1_INIT + 7)
