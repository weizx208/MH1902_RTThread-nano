...
#define MH_RET_SM2_ERR                      (MH_RET_SM2_INIT + 0x02)
#define MH_RET_SM2_FAILURE                  (MH_RET_SM2_INIT + 0x03)
#define MH_RET_SM2_VERIFY_SIGN_FAILURE      (MH_RET_SM2_INIT + 0x04)
#define MH_RET_SM2_KDF_FAILURE              (MH_RET_SM2_INIT + 0x05)
#define MH_RET_SM2_VERIFY_KEY_FAILURE       (MH_RET_SM2_INIT + 0x06)
#define MH_RET_SM2_VERIFY_POINT_FAILURE     (MH_RET_SM2_INIT + 0x07)
